...
<body>
    ...
    <div class="jumbotron">
        <div class="container bg-light p-5 rounded mt-5">
            ...
            <form class="m-3" action="lattes_xml_to_elastic_dedup.php" method="post" accept-charset="utf-8"
                ...
                <div class="input-group">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="fileXML" aria-describedby="fileXML"
                            name="file">
            ...
            <form class="m-3" action="doi_to_elastic.php" method="get">
                ...
                <div class="input-group">
                    ...
                    <input type="text" placeholder="Insira um DOI" class="form-control" name="doi"
            ...
            <form class="m-3" action="wos_upload.php" method="post" accept-charset="utf-8"
                enctype="multipart/form-data">
            ...
            <form class="m-3" action="incites_upload.php" method="post" accept-charset="utf-8"
                enctype="multipart/form-data">
            ...
            <form class="m-3" action="scopus_upload.php" method="post" accept-charset="utf-8"
                enctype="multipart/form-data">
            ...
            <form class="m-3" action="scival_upload.php" method="post" accept-charset="utf-8"
                enctype="multipart/form-data">
