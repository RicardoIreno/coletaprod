  ...
  <div class="result-container">
    ...
    <main class="result-main">
      ...
      foreach ($cursor["hits"]["hits"] as $r) {
        ...
        !empty($r['_source']['isPartOf']['name']) ? $issn = $r['_source']['isPartOf']['name'] : $issn = '';
        ...
        Production::IntelectualProduction(
          ...
          $doi = $doi,
          $issn = $issn,
          $refName =  $r['_source']['isPartOf']['name'],
          $refVol = '',
          $refFascicle = '',
          $refPage = '',
          $event = '',
      ...
      ui::newpagination($page, $total, $limit, $_POST, 'result_test');
      ?>
