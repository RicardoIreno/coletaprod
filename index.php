        ...
        <div id="mySearch" class="search">
          ...
          <div class="u-div-v">
            ...
            <span v-if="searchPage == 'simple'">
              <svg class="btn-ico" x="0px" y="0px" viewBox="0 0 80 48"><path class="st0" d="M7.7,10c0.7,0,1.5,0.2,2.2,0.5L39.7,25l30.6-14c2.5-1.1,5.5,0,6.6,2.5c1.1,2.5,0,5.5-2.5,6.6l-32.7,15
                c-1.4,0.6-2.9,0.6-4.3-0.1l-32-15.6C3,18.2,2,15.2,3.2,12.8C4,11,5.8,10,7.7,10z"/></svg>
              </span>
            <span v-if="searchPage == 'advanced'">
              <svg class="btn-ico" x="0px" y="0px" viewBox="0 0 80 48" ><path class="st0" d="M72.3,35.5c-0.7,0-1.5-0.2-2.2-0.5L40.3,20.5l-30.6,14c-2.5,1.1-5.5,0-6.6-2.5c-1.1-2.5,0-5.5,2.5-6.6l32.7-15
                c1.4-0.6,2.9-0.6,4.3,0.1l32,15.6c2.5,1.2,3.5,4.2,2.3,6.7C76,34.5,74.2,35.5,72.3,35.5z"/></svg>
              </span>
          </button>
          ...
          <div class="u-div-v" v-if="searchPage == 'advanced'"> 
            ...
            <form class="myform" action="result.php" title="Mais opções de pesquisa"></form>	
              ...
              <input 
                class="search-input" 
                type="search" 
                placeholder="Filtrar por Nome do Programa de Pós-Graduação (Opcional)" 
                aria-label="Mudar" 
                name="search"
              >
              ...
              <input 
                ...
                id="authorsDataList" 
                placeholder="Filtrar por nome ou ID Lattes do autor" 
                name="filter[]" 
                v-model="query" 
                @input="searchCV()"
              >
          ...
          <small class="u-info">Dica: Use * para busca por radical. Ex: biblio*.</small><br />
          <small class="u-info">Dica 2: Para buscas exatas, coloque entre "". Ex: "Direito civil"</small><br />
          <small class="u-info">Dica 3: Por padrão, o sistema utiliza o operador booleano OR. Caso necessite deixar a busca mais específica, utilize o operador AND (em maiúscula)</small>
