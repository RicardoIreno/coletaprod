    ...
    <div class="pi">
      ...
      <div class="u-grid">
        ...
        <div class="u-grid-left">
          <img class="pi-icon" src="../inc/images/icons/article-preprint.svg" />
        </div>            
        ...
        <div class="u-grid-right">
          ...
          <h4 class="ty-item">Nome da produção</h4>
          
          <span class="u-sr-only">Autores</span>
          <p class="pi-authors"> Auto A, Autor B, ...</p>
          ...
          <div class="pi-moreinfo">
            ...
            <div class="pi-moreinfo-item"> 
              ...
              <span class="pi-citations">Scopus 14</span>
            ...
            <div class="pi-moreinfo-item"> 
              ...
              <a href="" target="blank">Acessar o conteúdo</a>
            </div>
            ...
            <div class="pi-moreinfo-item">
              ...
              <a href=""> Acessar o DOI</a>
            </div>

            <div class="pi-moreinfo-item">
              <a href=""> ISSN: prod.issn</a>
            </div>
