...
<body class="manual-body">
    ...
    <div class="manual-wrapper u-center">
      <div class="pre-dash-content">
        ...
        <p>O Prodmais utiliza a ferramenta Elastic Search para oferecer um poderoso dashboard com dados detalhados sobre a base de produção acadêmica. Você pode consultar duas categorias de dashboard: produção acadêmica e perfil dos pesquisadores.</p>


          <a 
          class="mybtn mybtn-manual div-h" 
          href="http://200.144.92.58/kibana/app/kibana#/dashboard/26076fa0-618c-11ec-9863-4f7d48084ff8?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15m%2Cto%3Anow))">
          Produção Acadêmica 
        </a>
        
        <a 
          class="mybtn mybtn-manual div-h" 
          href="http://200.144.92.58/kibana/app/kibana#/dashboard/568e12f0-618c-11ec-9863-4f7d48084ff8?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15m%2Cto%3Anow))">
